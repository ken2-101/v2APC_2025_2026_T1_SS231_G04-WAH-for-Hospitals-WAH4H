...
import { Activity, FileText, Pill, FlaskConical, Stethoscope, Bed, Clock } from 'lucide-react';
                                ...
                                <div key={event.id} className="relative">
                                    ...
                                    <div>
                                        <div className="flex items-center gap-2 mb-1">
                                            ...
                                            <span className="text-xs text-gray-500">{new Date(event.dateTime).toLocaleString()}</span>
                                        </div>
