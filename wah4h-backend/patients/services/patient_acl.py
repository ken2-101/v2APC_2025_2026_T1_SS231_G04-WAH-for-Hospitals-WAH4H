...
def _patient_to_full_dict(patient: Patient) -> Dict[str, Any]:
    ...
    return {
        ...
        'gender': patient.gender or "",
        'birthdate': patient.birthdate.isoformat() if patient.birthdate else None,
        'age': _calculate_age(patient.birthdate) if patient.birthdate else 0,
        'civil_status': patient.civil_status or "",
        'nationality': patient.nationality or "",
        'religion': patient.religion or "",
        'race': patient.race or "",  # FHIR PH Core extension
        'philhealth_id': patient.philhealth_id or "",
        'blood_type': patient.blood_type or "",
        ...
        'full_address': _compute_full_address(patient),
        ...
        'indigenous_flag': patient.indigenous_flag if patient.indigenous_flag is not None else False,
        'indigenous_group': patient.indigenous_group or "",
        'consent_flag': patient.consent_flag if patient.consent_flag is not None else False,
        'active': patient.active if patient.active is not None else True,  # FHIR standard field
