    ...
    operations = [
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        ...
                        name="inventory_item_co_d52c7a_idx",
                    ),
                    models.Index(
                        fields=["expiry_date"], name="inventory_expiry__6e8fe4_idx"
                    ),
                ],
            },
        ),
        migrations.CreateModel(
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        fields=["code_code"], name="medication_code_co_014a56_idx"
                    )
                ],
            },
        ),
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        ...
                        name="medication__subject_0876d0_idx",
                    ),
                    models.Index(
                        fields=["request_id"], name="medication__request_0fce2b_idx"
                    ),
                ],
            },
        ),
            ...
            fields=[
                ...
                (
                    ...
                    models.OneToOneField(
                        ...
                        related_name="dosage",
                        to="pharmacy.medicationadministration",
                    ),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        fields=["subject_id", "encounter_id"],
                        name="medication__subject_5cafee_idx",
                    ),
                    models.Index(
                        fields=["status", "authored_on"],
                        name="medication__status_200812_idx",
                    ),
                ],
            },
        ),
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        ...
                        name="medication__medicat_88ffff_idx",
                    )
                ],
            },
        ),
