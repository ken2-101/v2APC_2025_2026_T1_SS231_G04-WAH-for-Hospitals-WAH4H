    ...
    def get_encounter_details(encounter_id: int) -> Optional[Dict[str, Any]]:
        ...
        try:
            ...
            return {
                ...
                'location_ids': encounter.location_ids,
                'location_summary': location_summary,
                'location_status': encounter.location_status,
                'ward': encounter.location_status.split('|')[0] if encounter.location_status and '|' in encounter.location_status else None,
                'room': encounter.location_status.split('|')[1] if encounter.location_status and len(encounter.location_status.split('|')) > 1 else None,
                'bed': encounter.location_status.split('|')[2] if encounter.location_status and len(encounter.location_status.split('|')) > 2 else None,
